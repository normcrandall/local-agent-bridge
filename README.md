...
- When adding **Commit statuses: Read and write** to an already-installed reviewer App, save the App settings and then approve the installation's requested permission update for every personal account or organization where it is installed. Changing the App definition alone does not upgrade existing installation tokens.
