...
try {
  ...
  console.log("Worker supervisor test passed: independent clients share a daemon, client exit is harmless, exits are receipted, restart adopts live workers, and cancellation remains intentional.");
} finally {
  for (const id of ids) {
    try {
